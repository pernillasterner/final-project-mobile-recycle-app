export const IconCart = () => {
  return (
    ...
    >
      <path
        d="M5.7 13.6462C4.655 13.6462 3.8095 14.4138 3.8095 15.352C3.8095 16.2902 4.655 17.0578 5.7 17.0578C6.745 17.0578 7.6 16.2902 7.6 15.352C7.6 14.4138 6.745 13.6462 5.7 13.6462ZM0 0V1.70578H1.9L5.32 8.17921L4.0375 10.2688C3.8855 10.5076 3.8 10.789 3.8 11.0876C3.8 12.0257 4.655 12.7933 5.7 12.7933H17.1V11.0876H6.099C5.966 11.0876 5.8615 10.9937 5.8615 10.8743L5.89 10.772L6.745 9.38178H13.8225C14.535 9.38178 15.162 9.0321 15.485 8.50331L18.886 2.96805C18.962 2.84865 19 2.70366 19 2.55867C19 2.08958 18.5725 1.70578 18.05 1.70578H3.9995L3.1065 0H0ZM15.2 13.6462C14.155 13.6462 13.3095 14.4138 13.3095 15.352C13.3095 16.2902 14.155 17.0578 15.2 17.0578C16.245 17.0578 17.1 16.2902 17.1 15.352C17.1 14.4138 16.245 13.6462 15.2 13.6462Z"
        fill="white"
      />
    </svg>
  );
...
export const IconInstagram = () => {
  return (
    ...
    >
      <path
        d="M39 0C17.496 0 0 17.496 0 39C0 60.504 17.496 78 39 78C60.504 78 78 60.504 78 39C78 17.496 60.504 0 39 0ZM28.998 12H48.9961C58.3711 12 66 19.626 66 28.998V48.9961C66 58.3711 58.374 66 49.002 66H29.0039C19.6289 66 12 58.374 12 49.002V29.0039C12 19.6289 19.626 12 28.998 12ZM28.998 18C22.935 18 18 22.9379 18 29.0039V49.002C18 55.065 22.9379 60 29.0039 60H49.002C55.065 60 60 55.0621 60 48.9961V28.998C60 22.935 55.0621 18 48.9961 18H28.998ZM53.0039 22.998C54.1079 22.998 55.002 23.8921 55.002 24.9961C55.002 26.1001 54.1079 27 53.0039 27C51.8999 27 51 26.1001 51 24.9961C51 23.8921 51.8999 22.998 53.0039 22.998ZM39 24C47.271 24 54 30.729 54 39C54 47.271 47.271 54 39 54C30.729 54 24 47.271 24 39C24 30.729 30.729 24 39 24ZM39 30C36.6131 30 34.3239 30.9482 32.636 32.636C30.9482 34.3239 30 36.6131 30 39C30 41.3869 30.9482 43.6761 32.636 45.364C34.3239 47.0518 36.6131 48 39 48C41.3869 48 43.6761 47.0518 45.364 45.364C47.0518 43.6761 48 41.3869 48 39C48 36.6131 47.0518 34.3239 45.364 32.636C43.6761 30.9482 41.3869 30 39 30Z"
        fill="#848895"
      />
    </svg>
  );
